...
namespace Castle.ActiveWriter
{
	...
	public abstract partial class ClassShapeBase : DslDiagrams::CompartmentShape
	{
		...
		protected override DslDiagrams::CompartmentMapping[] GetCompartmentMappings(global::System.Type melType)
		{
			...
			internal static global::System.Collections.IList GetElementsFromModelClassForProperties(DslModeling::ModelElement rootElement)
			{
				global::Castle.ActiveWriter.ModelClass root = (global::Castle.ActiveWriter.ModelClass)rootElement;
					// Segments 0 and 1
...
namespace Castle.ActiveWriter
{
	...
	public abstract partial class NestedClassShapeBase : DslDiagrams::CompartmentShape
	{
		...
		protected override DslDiagrams::CompartmentMapping[] GetCompartmentMappings(global::System.Type melType)
		{
			...
			#region DomainPath traversal methods to get the list of elements to display in a compartment.
			internal static global::System.Collections.IList GetElementsFromNestedClassForProperties(DslModeling::ModelElement rootElement)
			{
				global::Castle.ActiveWriter.NestedClass root = (global::Castle.ActiveWriter.NestedClass)rootElement;
					// Segments 0 and 1
					DslModeling::LinkedElementCollection<global::Castle.ActiveWriter.ModelProperty> result = root.Properties;
				return result;
			}
